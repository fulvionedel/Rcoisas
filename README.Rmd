...
O pacote contém funções com _outputs_ em português e bancos de dados úteis para a produção de gráficos e tabelas para aulas, como a descrição "completa" de uma variável numérica ou a construção de indicadores de saúde, como a curva de Nelson de Moraes. 
