...
#' 
#' @param x Vetor (de caracteres ou numérico) com algarismos arábicos.
#' @param n Limite do número de zeros a incluir; o padrão é `NULL`, sendo então definido pela função como o necessário até alcançar o número máximo de characteres do vetor; pode ser definido pelo usuário.
#' 
#' @returns Vetor de caracteres com os dígitos vazios à esquerda do valor original preenchidos por zero (0).
#' 
#' @details
