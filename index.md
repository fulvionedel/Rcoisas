...
- [Exemplos](#exemplos)
  - [Descrição univariada](#descri%C3%A7%C3%A3o-univariada)
    - [Variáveis numéricas](#vari%C3%A1veis-num%C3%A9ricas)
    - [Variáveis categóricas](#vari%C3%A1veis-categ%C3%B3ricas)
...
como a curva de Nelson de Moraes. Veja a ajuda para a lista completa e
detalhamento das funções e bancos de dados no pacote.
...
> `` `r formatL(tabolero$RP, 2)` ``;
> IC₉₅`` `r formatL(tabolero$lci.rp, 2)` `` a
