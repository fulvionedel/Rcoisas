...
- [Exemplos](#exemplos)
  ...
  - [Tabelas 2 $\times$ 2](#tabelas-2-times-2)
...
<img src="man/figures/README-unnamed-chunk-4-1.png" width="48%" style="display: block; margin: auto;" />
    ...
    Menor: -3.09     Maior: 3.2  Amplitude: 6.29
    Média: -0.04     DP: 1.02    CV(%): 2522.67
    Assimetria: 0.03     Curtose(real): 2.93
    Quantis:
     2.5%    5%   25%   50%   75%   95% 97.5% 
    -2.03 -1.71 -0.73 -0.05  0.67  1.61  1.97 
              IIQ: 1.4 
...
[1] "Média de -0.04 e desvio-padrão de 1.02 unidades, configurando um coeficiente de variação de 2522.67 %."
```
